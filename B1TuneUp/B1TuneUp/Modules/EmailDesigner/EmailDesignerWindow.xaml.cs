...
{
    public partial class EmailDesignerWindow : Window
    {
        private readonly EmailDesignerViewModel _viewModel = new EmailDesignerViewModel();

        public EmailDesignerWindow()
        {
            InitializeComponent();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "Email & Notification Designer · SAP Business One HANA"
                : "Email & Notification Designer · SAP Business One SQL";
            Loaded -= OnLoaded;
