...
{
    public partial class RuleBuilderWindow : Window
    {
        private readonly RuleBuilderViewModel _viewModel = new RuleBuilderViewModel();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "Rule Builder · SAP Business One HANA"
                : "Rule Builder · SAP Business One SQL";
            Loaded -= OnLoaded;
