...
{
    public partial class MacroEngineWindow : Window
    {
        private readonly MacroEngineViewModel _viewModel;

        public MacroEngineWindow()
        {
            InitializeComponent();
            _viewModel = new MacroEngineViewModel();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "B1TuneUp Macro Engine Studio - SAP Business One HANA"
                : "B1TuneUp Macro Engine Studio - SAP Business One SQL";
