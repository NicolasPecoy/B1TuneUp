...
{
    public partial class FormEnhancementWindow : Window
    {
        private readonly FormEnhancementViewModel _viewModel;

        public FormEnhancementWindow()
        {
            InitializeComponent();
            _viewModel = new FormEnhancementViewModel();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "B1TuneUp Form Enhancements Studio - SAP Business One HANA"
                : "B1TuneUp Form Enhancements Studio - SAP Business One SQL";
