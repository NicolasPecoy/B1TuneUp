...
{
    public partial class ActionQuickWindow : Window
    {
        private readonly ActionQuickViewModel _viewModel;

        public ActionQuickWindow()
        {
            InitializeComponent();
            _viewModel = new ActionQuickViewModel();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "B1TuneUp Action Pad Studio - SAP Business One HANA"
                : "B1TuneUp Action Pad Studio - SAP Business One SQL";
