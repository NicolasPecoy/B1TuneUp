...
{
    public partial class ProcessDesignerWindow : Window
    {
        private readonly ProcessDesignerViewModel _viewModel = new ProcessDesignerViewModel();

        public ProcessDesignerWindow()
        {
            InitializeComponent();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "Process Designer · SAP Business One HANA"
                : "Process Designer · SAP Business One SQL";
            Loaded -= OnLoaded;
