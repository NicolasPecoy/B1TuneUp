...
{
    public partial class PlacementEnhancementWindow : Window
    {
        private readonly PlacementEnhancementViewModel _viewModel;

        public PlacementEnhancementWindow()
        {
            InitializeComponent();
            _viewModel = new PlacementEnhancementViewModel();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "B1TuneUp Item Placement & UI Enhancer - SAP Business One HANA"
                : "B1TuneUp Item Placement & UI Enhancer - SAP Business One SQL";
            await _viewModel.LoadLayoutsAsync();
        }
