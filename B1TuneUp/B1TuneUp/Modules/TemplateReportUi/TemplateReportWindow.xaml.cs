...
{
    public partial class TemplateReportWindow : Window
    {
        private readonly TemplateReportViewModel _viewModel = new TemplateReportViewModel();

        public TemplateReportWindow()
        {
            InitializeComponent();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "Template & Report Studio · SAP Business One HANA"
                : "Template & Report Studio · SAP Business One SQL";
            Loaded -= OnLoaded;
