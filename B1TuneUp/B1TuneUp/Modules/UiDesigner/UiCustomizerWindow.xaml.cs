...
{
    public partial class UiCustomizerWindow : Window
    {
        private readonly UiCustomizerViewModel _viewModel = new UiCustomizerViewModel();

        public UiCustomizerWindow()
        {
            InitializeComponent();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Title = B1App.Instance?.IsHana == true
                ? "B1TuneUp UI Customizer · SAP Business One HANA"
                : "B1TuneUp UI Customizer · SAP Business One SQL";
            Loaded -= OnLoaded;
